...
### Added
- Implemented multi-threading for core engine operations (`find`, `count`, `update`, `delete`) using the `rayon` crate, significantly improving performance on multi-core systems.
